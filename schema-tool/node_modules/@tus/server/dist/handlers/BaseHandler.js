...
class BaseHandler extends node_events_1.default {
    ...
    writeToStore(data, upload, maxFileSize, context) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            const postReceive = (0, lodash_throttle_1.default)((offset) => {
                this.emit(utils_1.EVENTS.POST_RECEIVE_V2, data, { ...upload, offset });
            ...
            promises_1.default
                .pipeline(data.pipe(proxy), new utils_1.StreamLimiter(maxFileSize), async (stream) => {
